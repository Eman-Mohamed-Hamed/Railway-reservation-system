...
// let hassan = document.querySelector(".hassasn");

// let ourProduct = JSON.parse(localStorage.getItem("cartona")) || [];
...
//     };
//     ourProduct.push(ticket);
//     localStorage.setItem("cartona" , JSON.stringify(ourProduct));

//     //console.log(localStorage.getItem( JSON.parse("cartona")));
     
//     // console.log(JSON.parse(localStorage.getItem("cartona")))
// alert("success")
...
//  let res=document.getElementById("reservate");
//  let bok=document.getElementById("boook");
//  let resFirstClick=0;
//  let bokFirstClick=0;

//  res.addEventListener("click", ()=>{
//     resFirstClick=resFirstClick+1;
//     if(resFirstClick==1){
//     window.open("http://127.0.0.1:5500/login.html");}
//     else{ res.href="http://127.0.0.1:5500/Reservation.html"; }
    
// });

// bok.addEventListener("click", ()=>{
//     bokFirstClick=bokFirstClick+1;
//     if(bokFirstClick==1){
//     window.open("http://127.0.0.1:5500/login.html");}
//     else{  bok.href="http://127.0.0.1:5500/train-booking.html"; }
